...
INSERT INTO user_enterprise (email, img_perfil, nome, password, username, cnpj) VALUES ('admin.taligado@fiap.com', 'https://abrir.link/eiEEK', 'Admin TáLigadoFIAP', '$2a$12$.BdU8Soj10fRyyYm5hEN8uVrtE0VDHFd5KdcWxMtAjInL2FqSOC1G', 'taligado_admin', '12.345.678/0001-90');

INSERT INTO user_roles (id_user, id_role) VALUES ((SELECT id FROM user_enterprise WHERE username = 'taligado_admin'), (SELECT id FROM role WHERE role_name = 'ADMIN'));
